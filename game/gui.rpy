...
define gui.accent_color = '#212f3d'

## The color used for a text button when it is neither selected nor hovered.
define gui.idle_color = '#7f8c8d'

## The small color is used for small text, which needs to be brighter/darker to
## achieve the same effect.
define gui.idle_small_color = '#7f8c8d'

## The color that is used for buttons and bars that are hovered.
define gui.hover_color = '#aab7b8'

## The color used for a text button when it is selected but not focused. A
## button is selected if it is the current screen or preference value.
define gui.selected_color = '#2e4053'

## The color used for a text button when it cannot be selected.
define gui.insensitive_color = '#2e4053'

## Colors used for the portions of bars that are not filled in. These are not
## used directly, but are used when re-generating bar image files.
define gui.muted_color = '#aab7b8'
define gui.hover_muted_color = '#aab7b8'

## The colors used for dialogue and menu choice text.
define gui.text_color = '#212f3d'
define gui.interface_text_color = '#212f3d'
...
define gui.choice_button_borders = Borders(100, 10, 100, 15)
define gui.choice_button_text_font = gui.text_font
define gui.choice_button_text_size = gui.text_size
define gui.choice_button_text_xalign = 0.5
define gui.choice_button_text_idle_color = "#7f8c8d"
define gui.choice_button_text_hover_color = "#212f3d"
